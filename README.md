...
```bash
git clone [https://github.com/ShiyadChathoth/sos.git](https://github.com/ShiyadChathoth/sos.git) && cd sos && chmod +x install_sos.sh && sudo ./install_sos.sh ./SOS-Game-x86_64-glibc2.27.AppImage
